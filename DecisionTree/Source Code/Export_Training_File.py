...
rootdir = "C:/Users/trieu/PycharmProjects/DecisionTree/Src-Virus-Trainning/"
output = "C:/Users/trieu/PycharmProjects/DecisionTree/ExportTraining.csv"
class_label = ['1']
class_labe0 = ['0']
f = open(output, 'wt')
writer = csv.writer(f)
writer.writerow(IMAGE_DOS_HEADER + FILE_HEADER + OPTIONAL_HEADER + ['Flag'])
    ...
    for file in files:
        ...
        try:
            ...
            try:
                ...
                head, taid = file.split("_")

                if head == "TROJ":
                    writer.writerow(features + class_label)
                    print file," exported"
                else:
                    writer.writerow(features + class_labe0)
                    print  file, " exported"
            except Exception, e:
